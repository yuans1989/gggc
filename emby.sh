...
wget -P /var/packages/EmbyServer/target/system/ --no-check-certificate https://yuans1989.github.io/gggs/linux64_docker64_4.7.5/Emby.Web.dll
...
wget -P /var/packages/EmbyServer/target/system/ --no-check-certificate https://yuans1989.github.io/gggs/linux64_docker64_4.7.5/MediaBrowser.Model.dll
echo "------------web核心完成------------"
...
wget -P /var/packages/EmbyServer/target/system/dashboard-ui/modules/emby-apiclient/ --no-check-certificate https://yuans1989.github.io/gggs/linux64_docker64_4.7.5/dashboard-ui/modules/emby-apiclient/connectionmanager.js
...
wget -P /var/packages/EmbyServer/target/system/dashboard-ui/embypremiere/ --no-check-certificate https://yuans1989.github.io/gggs/linux64_docker64_4.7.5/dashboard-ui/embypremiere/embypremiere.js
echo "------------web完成------------"
echo "----------------硬解部分----------------"
...
wget -P /var/packages/EmbyServer/target/system/ --no-check-certificate https://yuans1989.github.io/gggs/linux64_docker64_4.7.5/Emby.Server.Implementations.dll
